...
#ifndef SWIFTLIBRARY_SWIFT_H
#define SWIFTLIBRARY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftLibrary",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("SwiftLibrary", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
SWIFT_EXTERN bool $s12SwiftLibrary12authenticate16localized_reason0d1_E4_lenSbSPys5UInt8VG_AFtF(uint8_t const * _Nonnull localized_reason, uint8_t localized_reason_len) SWIFT_NOEXCEPT SWIFT_CALL; // authenticate(localized_reason:localized_reason_len:)
...
SWIFT_INLINE_THUNK bool authenticate(uint8_t const * _Nonnull localized_reason, uint8_t localized_reason_len) noexcept SWIFT_SYMBOL("s:12SwiftLibrary12authenticate16localized_reason0d1_E4_lenSbSPys5UInt8VG_AFtF") SWIFT_WARN_UNUSED_RESULT {
  return SwiftLibrary::_impl::$s12SwiftLibrary12authenticate16localized_reason0d1_E4_lenSbSPys5UInt8VG_AFtF(localized_reason, localized_reason_len);
}
