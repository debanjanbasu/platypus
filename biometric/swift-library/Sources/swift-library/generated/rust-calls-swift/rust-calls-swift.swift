...
func __swift_bridge__authenticate (_ localized_reason: UnsafeMutableRawPointer, _ result: UnsafeMutableRawPointer) {
    { let cb1 = __private__RustFnOnceCallback$authenticate$param1(ptr: result); let _ = authenticate(localized_reason: RustString(ptr: localized_reason), result: { arg0 in cb1.call(arg0) }) }()
}
